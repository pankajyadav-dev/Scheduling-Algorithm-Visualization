...
function ProcessInputForm({ processes, setProcesses, timeQuantum, setTimeQuantum, queues, setQueues }) {
  ...
  return (
    <div className="ml-8 mb-8 flex flex-col flex-wrap">
      ...
      <div className='border-2 border-blue-900 rounded-lg p-4 w-1/2'>
